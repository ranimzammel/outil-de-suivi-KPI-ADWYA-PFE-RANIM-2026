...
with st.sidebar:
    ...
    PCI           = st.number_input("PCI gaz naturel (kWh/Nm³)", value=10.467, step=0.001)
    ...
    eta_th_nom   = st.number_input("rendement thermique estimé",       value=0.30,  step=0.01)
    eta_frig_nom = st.number_input("rendement frigorifique estimé",     value=0.235, step=0.005)
    eta_glob_nom = st.number_input("rendement global nominal",   value=0.80, step=0.01)
...
# =============================================================================
COLONNES = ["mois", "h_service", "prod_nette", "gaz", "froid", "chaleur", "chaleurzone", "COP"]

#  mois           h_serv  prod_nette    gaz        froid     chaleur     COP
DATA_DEFAUT = [
    # ── Anciennes données (mai 2024 – mai 2025) ─────────────────────────────
    ("Mai  2024",  262,  864_000,  198_116,        0,  476_974,  68_686,  None ),  # démarrage — pas de froid
    ("Juin 2024",  710,  849_600,  192_530,  175_145,  510_983, 502_139,  0.399),
    ("Juil 2024",  576,  720_000,  154_636,  182_092,  384_522, 566_520,  0.573),
    ("Août 2024",  437,  518_400,  114_942,   23_456,  221_970, 403_120,  0.118),
    ("Sept 2024",  669,  798_000,  179_737,  212_682,  371_949, 386_690,  0.746),
    ("Oct  2024",  742,  882_390,  197_633,  320_251,  495_215,  83_343,  0.778),
    ("Nov  2024",  687,  821_060,  186_451,  176_946,  432_365, 513_079,  0.554),
    ("Déc  2024",  739,  881_170,  198_821,  151_977,  490_387, 593_449,  0.512),
    ("Jan  2025",  731,  875_100,  196_592,        0,  170_709, 170_709,  None ),  # panne absorption
    ("Fév  2025",  656,  786_630,  176_950,  112_379,  325_380, 516_852,  0.539),
    ("Mars 2025",  724,  783_710,  176_210,  169_547,  418_558, 510_690,  0.551),
    ("Avr  2025",  698,  923_840,  209_513,  204_424,  483_363, 523_051,  0.567),
    ("Mai  2025",  731,  878_260,  199_061,  217_045,  488_018, 530_602,  0.607),
    # ── Nouvelles données (juin 2025 – mars 2026) ────────────────────────────
    ("Juin 2025",  668,  802_300,  181_636,  174_776,  431_932, 424_392,  0.568),
    ("Juil 2025",  585,  684_810,  154_744,   91_827,  253_989, 293_700,  0.573),
    ("Août 2025",  423,  500_080,  115_157,    4_160,   45_834, 237_608,  0.506),
    ("Sept 2025",  711,  848_800,  193_717,        0,  137_424, 537_424,  None ),  # abs. hors service
    ("Oct  2025",  706,  842_070,  192_125,  199_696,  417_421, 522_168,  0.676),
    ("Nov  2025",  672,  805_550,  182_997,  228_292,  507_470, 576_569,  0.690),
    ("Déc  2025",  678,  804_230,  182_252,  218_581,  523_373, 175_553,  0.628),
    ("Jan  2026",  741,  890_300,  199_706,  178_501,  522_157, 200_118,  0.554),
    ("Fév  2026",  663,  794_380,  178_295,   85_310,  278_336, 229_076,  0.572),
    ("Mars 2026",  700,  840_540,  189_806,   21_305,   55_615,  20_626,  0.609),
]
...
df_raw["eta_glob"] = df_raw["eta_e"] + df_raw["eta_th"] 
